...
import Jimp from 'jimp/es' //TONOTICE: this lib was chosen because it is purely written in Javascript. If it contained parts written in some "non-native" lang, it should have been recompiled SPECIFICALLY FOR AWS LAMBDA.
